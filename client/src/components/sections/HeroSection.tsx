      ...
      <Container>
        <div className="flex flex-col md:flex-row items-center">
          ...
          >
            ...
            >
              <Button className="px-6 py-6 bg-primary text-white rounded-lg font-medium hover:bg-neutral-700 transition-colors flex items-center justify-center h-12 w-full sm:w-auto">
                Get Started <ArrowRight className="ml-2 h-4 w-4" />
              </Button>
              <Button variant="outline" className="px-6 py-6 border border-neutral-200 rounded-lg font-medium hover:bg-neutral-100 transition-colors flex items-center justify-center h-12 w-full sm:w-auto">
                View Documentation
              </Button>
            </motion.div>
            <motion.div
          ...
          >
            <div className="relative bg-neutral-100 rounded-xl p-4 sm:p-6 md:p-8 border border-neutral-200 mx-4 md:mx-0">
              {/* Authentication Visualization */}
              <div className="flex flex-col items-center">
                <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-full bg-white border border-neutral-200 flex items-center justify-center mb-4 sm:mb-6">
...
console.log("Authenticated!", userWallet.address);`}
                ...
                {/* Success state */}
                <div className="w-full bg-white rounded-lg p-2 sm:p-4 border border-success flex flex-wrap sm:flex-nowrap items-center mt-4 text-sm sm:text-base">
